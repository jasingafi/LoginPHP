				...
				<form class="form-horizontal" role="form" action="<?php $_SERVER["PHP_SELF"]; ?>" method="POST">
					<div class="form-group">
						<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Asignatura </label>
							<div class="col-sm-9">
								<input type="text"  name="nombre" placeholder="Nombre de la Clase" class="col-xs-10 col-sm-5" required />
							</div>
					</div>
					...
					<div class="form-group">
						<label class="col-sm-3 control-label no-padding-right" for="form-field-1-1"> Nota Final </label>
							<div class="col-sm-9">
								<input type="number"  name="unidades" placeholder="Nota Obtenida" class="col-xs-10 col-sm-5"  required/>
							</div>
					</div>
					...
					<div class="clearfix form-actions">
						<div class="col-md-offset-3 col-md-9">
							<button class="btn btn-info" type="submit" name="registrar">
