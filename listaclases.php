...
<div class="row">
	<div class="col-xs-12">
		<h3 class="header smaller lighter blue">Historial Personal de Clases
			<button class="btn btn-white btn-info btn-bold">
				<i class="ace-icon fa fa-floppy-o bigger-120 blue"></i>
					<a href="RegistroClases.php">Registrar Nueva Clases</a>
			</button>
		</h3>
			...
			<div class="table-header">
				Resultados para "Historial de Clases "
			</div>
 ...
 <?php
        while ($regmaterias = $resultadomaterias->fetch_array(MYSQLI_BOTH)) {
           echo "<tr>
            <td>".$regmaterias['nombre_materia']."</td>
             <td class='center'>".$regmaterias['unidades']."</td>
             <td class='center'><a href='Editarmateria.php?id=".$regmaterias['idmateria']."'>
             	<span class='green'> 	<i class='ace-icon fa fa-pencil-square-o bigger-120'></i></span>
	       </a>
	  </td>
              <td class='center'><a href='Eliminarmateria.php?id=".$regmaterias['idmateria'] ."'>
