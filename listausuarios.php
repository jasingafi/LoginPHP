	...
	<div class="col-xs-12">
		<h3 class="header smaller lighter blue">Registro de Usuarios
			...
			<div class="table-header">
				Resultados para "Registro de Usuarios "
			</div>
        ...
        <tbody>
               <?php
                      while ($reguser = $resultadoalumnos->fetch_array(MYSQLI_BOTH)) {
                        # code SELECT COUNT(idmateria) FROM materias WHERE idusuario = 5
                        ...
                        echo " <tr>
                                 ...
                                 <td class='center'><a href='Editarusuario.php?id=".$reguser['idusuarios']."'>
             			<span class='green'> 	<i class='ace-icon fa fa-pencil-square-o bigger-120'></i></span>
	      		 </a>
	 		 </td>
                                  <td class='center'><a href='Eliminarusario.php?id=".$reguser['idusuarios'] ."'>
